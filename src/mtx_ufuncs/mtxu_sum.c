...
/*   Updated: 2022/06/30 22:44:03 by iamongeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "mtxlib.h"

static t_mtx	*__route_sum_rowwise(t_mtx *mtx, t_mtx *out)
{
	int	out_null;
...
static t_mtx	*__route_sum_colwise(t_mtx *mtx, t_mtx *out)
{
	int	out_null;
...
static t_mtx	*__route_sum_whole(t_mtx *mtx, t_mtx *out)
{
	int	out_null;
