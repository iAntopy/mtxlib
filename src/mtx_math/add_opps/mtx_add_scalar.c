...
{
	__mtx_opp_scalar(a, b, a, __mtx_std_addf);
}

void	_mtx_addf_scalar(t_mtx *a, t_mtx *b, t_mtx *out)
{
	__mtx_opp_scalar(a, b, out, __mtx_std_addf);
}

void	_mtx_iaddi_scalar(t_mtx *a, t_mtx *b)
{
	__mtx_opp_scalar(a, b, a, __mtx_std_addi);
}

void	_mtx_addi_scalar(t_mtx *a, t_mtx *b, t_mtx *out)
{
	__mtx_opp_scalar(a, b, out, __mtx_std_addi);
}
/*
