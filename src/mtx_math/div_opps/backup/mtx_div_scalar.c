...
{
	__mtx_opp_scalar(a, b, a, __mtx_std_divf);
}

void	_mtx_divf_scalar(t_mtx *a, t_mtx *b, t_mtx *out)
{
	__mtx_opp_scalar(a, b, out, __mtx_std_divf);
}

void	_mtx_idivi_scalar(t_mtx *a, t_mtx *b)
{
	__mtx_opp_scalar(a, b, a, __mtx_std_divi);
}

void	_mtx_divi_scalar(t_mtx *a, t_mtx *b, t_mtx *out)
{
	__mtx_opp_scalar(a, b, out, __mtx_std_divi);
}
/*
