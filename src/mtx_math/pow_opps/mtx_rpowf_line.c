...
/*   Updated: 2023/03/01 04:20:37 by iamongeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	_mtx_opp_line_row(a, b, out, __mtx_std_rpowf);
}

void	_mtx_ripowf_line_r(t_mtx *a, t_mtx *b)
{
	_mtx_opp_line_row(a, b, a, __mtx_std_rpowf);
}

void	_mtx_rpowf_line_c(t_mtx *a, t_mtx *b, t_mtx *out)
{
	_mtx_opp_line_col(a, b, out, __mtx_std_rpowf);
}

void	_mtx_ripowf_line_c(t_mtx *a, t_mtx *b)
{
	_mtx_opp_line_col(a, b, a, __mtx_std_rpowf);
}
