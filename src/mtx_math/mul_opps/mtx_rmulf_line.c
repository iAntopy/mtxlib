...
{
	_mtx_opp_line_row(a, b, out, __mtx_std_rmulf);
}

void	_mtx_rimulf_line_r(t_mtx *a, t_mtx *b)
{
	_mtx_opp_line_row(a, b, a, __mtx_std_rmulf);
}

void	_mtx_rmulf_line_c(t_mtx *a, t_mtx *b, t_mtx *out)
{
	_mtx_opp_line_col(a, b, out, __mtx_std_rmulf);
}

void	_mtx_rimulf_line_c(t_mtx *a, t_mtx *b)
{
	_mtx_opp_line_col(a, b, a, __mtx_std_rmulf);
}
