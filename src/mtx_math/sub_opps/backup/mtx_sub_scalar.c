...
{
	__mtx_opp_scalar(a, b, a, __mtx_std_subf);
}

void	_mtx_subf_scalar(t_mtx *a, t_mtx *b, t_mtx *out)
{
	__mtx_opp_scalar(a, b, out, __mtx_std_subf);
}

void	_mtx_isubi_scalar(t_mtx *a, t_mtx *b)
{
	__mtx_opp_scalar(a, b, a, __mtx_std_subi);
}

void	_mtx_subi_scalar(t_mtx *a, t_mtx *b, t_mtx *out)
{
	__mtx_opp_scalar(a, b, out, __mtx_std_subi);
}
/*
