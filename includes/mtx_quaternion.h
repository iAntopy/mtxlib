...
/*   Updated: 2022/07/09 15:32:42 by iamongeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	_quat_update(t_quat *q, float vect[3], float ang);// Change q->uv x, y, z values in place and pass q->uv + 1 as vect[3]. q->uv will be normalized.
