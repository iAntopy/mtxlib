...
/*   Updated: 2023/03/01 04:43:10 by iamongeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// if q is NULL, mallocs and inits new quaternion.
// If declared t_quat on stack is passed as q, acts as mtx_shell().
t_quat	*quat_create_empty(t_quat *q);
// DO NOT declare vect outside. Change q->uv x, y, z values in place
// and pass q->uv + 1 as vect[3]. q->uv will be normalized.
...
// QUATERNION TRANSLATION (quaternion can also produce translation if desired.
// The translation is done post-rotation)
