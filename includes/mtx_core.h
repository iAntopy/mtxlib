...
int		*_mtx_index_iptr(t_mtx *mtx, int row, int col);
float	*_mtx_index_fptr(t_mtx *mtx, int row, int col);
int		_mtx_index_i(t_mtx *mtx, int row, int col);
float	_mtx_index_f(t_mtx *mtx, int row, int col);
